<html>
    ...
    <body>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown">
                      ...
                      <ul class="dropdown-menu">
                        ...
                        <li role="separator" class="divider"></li>
                        <li><a href="#" class="reset-button" data-language="bb">Baby</a></li>
                      </ul>
                    </li>
                    <li><a href="https://github.com/vigansub/kodenames_vig/"><tt>Source</tt></a></li>
                    <li><a href="https://www.patreon.com/words2">Donate</a></li>

                    <li><a href="https://vigansub.github.io/words2/"><i>Words 2.0<i> <span class="badge">new</span></a></li>
                </ul>
        ...
        <script>
            ...
            var baby_words = ["africa", "agent", "air", "alien", "alps", "amazon", "ambulance", "america", "angel", "antarctica", "apple", "arm", "atlantis", "australia", "aztec", "back", "ball", "band", "bank", "bar", "bark", "bat", "battery", "beach", "bear", "beat", "bed", "beijing", "bell", "belt", "berlin", "bermuda", "berry", "bill", "block", "board", "bolt", "bomb", "aa", "ab", "ac", "ad", "ae", "af"];
            var word_lists = {'en': english_words, 'pl': polish_words, 'bb': baby_words}
